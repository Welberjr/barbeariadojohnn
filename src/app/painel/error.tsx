...
/**
 * Error boundary do painel do barbeiro.
 * Isola erros de uma aba sem derrubar o painel inteiro:
 * o profissional vê um aviso amigável e pode tentar de novo ou voltar ao início.
 */
export default function PainelError({
  ...
  useEffect(() => {
    console.error('[painel] erro capturado pelo error boundary:', error);
  }, [error]);
